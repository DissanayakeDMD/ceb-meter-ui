...
const DEFAULT_FAILED_LIST_API =
  'https://localhost:7221/api/readings/FailedReadings';

/**
 * @param {{ listApiUrl?: string }} props — list API for failed rows (ordinary vs bulk).
 */
export default function FailedReadingTable({
  listApiUrl = DEFAULT_FAILED_LIST_API,
} = {}) {
